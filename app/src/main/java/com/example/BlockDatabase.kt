...
@Database(entities = [BlockedAppEntity::class, BlockedWebsiteEntity::class, ContentEventLogEntity::class], version = 3, exportSchema = false)
abstract class BlockDatabase : RoomDatabase() {
    abstract val dao: BlockedAppDao
    abstract val websiteDao: BlockedWebsiteDao
    abstract val contentEventLogDao: ContentEventLogDao
